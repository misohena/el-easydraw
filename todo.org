...
** TODO パス編集/パスツールで任意のサブパスの端点を延ばせるようにする
複数のサブパスがあるときに。
現在はpath dataの最初と最後しか延ばせない。
** TODO パス編集/パスツールで開サブパスと開サブパスを連結できるようにする
複数の開サブパスがあるときに、開サブパスの端から初めて別の開サブパスの端へjoinしたい。
** TODO パス編集/パスツールで開サブパスを閉じられるようにする
複数のサブパスがあるときに、一つの開サブパスの端から端へjoinしたい。
...
** TODO パス編集/複数のサブパスがあることによる問題を調査・修正する
...
** TODO パス編集/パスを滑らかにするコマンドを閉パスや複数サブパスに対応させる
