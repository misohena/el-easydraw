...
** TODO plist-getのGV版は少なくともEmacs27には無い
- edraw-import-svg-convert-element-attributes
- edraw-import-svg-convert-attr-style
- edraw-path-extra-props-set : この関数は使われていない。

** TODO Emacs27でテキスト装飾機能に問題がある
...
** TODO テキストとして制御文字が入ると即SVG全体が無効になる
C-q C-a等で制御文字を入れるとSVG画像全体が消えてしまう。
