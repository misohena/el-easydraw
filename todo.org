...
** TODO edraw-svg-printはtopとcommentという名前のタグがあったら動作しない
まぁ、仕方ないよね。
ただ、topの方は関数を分ければ対処可能。topかsvgと分かっている場所は専用の関数を呼ぶべき。もしくはトップ以外と分かっているところはedraw-svg-print-nodeみたいにするか。
...
** TODO edraw-mode/拡張子を.edraw.svgとせず.svgでもedraw-modeで開くようにする
...
** TODO 色/edraw-color-picker-replace-color-atは色名を認識すべき
