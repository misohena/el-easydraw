...
* Inbox
** TODO edraw-mode/専用のウィンドウで独立して動作するエディタを作る
...
** TODO edraw-mode/find-fileで新しいファイルを開くとキャンバスが出ない
多分バッファが空だと表示されない。

** TODO edraw-mode/ビューを常にウィンドウサイズに合わせる
** TODO edraw-mode/編集中にある程度文字が入力できてしまう
EnterやC-qで。
...
** TODO 変形/GUI変形時にマウスの位置に操作種類記号を表示する
拡大、回転、平行移動等
