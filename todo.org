...
* Inbox
** TODO edraw-svg-elem-propをedraw-svg-prop-infoへ改名する
もはや要素だけのプロパティじゃ無いし。
...
- [ ] edraw-svg-prop-info-to-string等を改名する。prop-to-にするかprop-value-to-にする。
  - edraw-svg-prop-info.*-to-
    - edraw-svg-prop-info-to-string
    - edraw-svg-prop-info-to-number
    - edraw-svg-prop-info-to-css-value
    - edraw-svg-prop-info-to-lisp-value
  ...
  - edraw-svg-prop-info-from-で始まるもの
    - edraw-svg-prop-info-from-string

** TODO booleanタイプを追加する
